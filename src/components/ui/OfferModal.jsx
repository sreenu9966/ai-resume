...
export function OfferModal({ isOpen, onClose, onApply, onLogin }) {
        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/70 backdrop-blur-md">
                ...
                >
                    ...
                    <button
                        onClick={onClose}
                        className="absolute top-4 right-4 text-slate-400 hover:text-white transition-colors z-20 p-1"
                    >
                        <X className="w-5 h-5" />
                    </button>
                    ...
                    <div className="p-8 text-center relative z-10">
                        ...
                        <h2 className="text-3xl font-bold text-white mb-2 flex flex-col items-center justify-center gap-2">
                            <span className="text-indigo-400">Happy New Year 2026</span>
                            <span className="flex items-center gap-2">Welcome Offer <Sparkles className="w-6 h-6 text-yellow-400" /></span>
                        </h2>
